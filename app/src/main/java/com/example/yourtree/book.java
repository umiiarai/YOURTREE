    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookpage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(book.this, book.class); // 나중에 시간표 불러오는 화면 생성 후 변경
        ...
        friendspage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(book.this, friends.class); // 나중에 시간표 불러오는 화면 생성 후 변경
                startActivity(intent); // 액티비티 이동
            }
        });
        ...
        graphpage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(book.this, graph.class); // 나중에 시간표 불러오는 화면 생성 후 변경
                startActivity(intent); // 액티비티 이동
            }
        });
        ...
        bookpage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(book.this, studytree.class); // 나중에 시간표 불러오는 화면 생성 후 변경
                startActivity(intent); // 액티비티 이동
            }
        });
    }
